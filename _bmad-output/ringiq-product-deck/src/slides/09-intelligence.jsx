    ...
    <div className="slide-page relative bg-bg-base text-text-primary">
      ...
      >
        ...
        <motion.h1
          ...
          className="font-display text-[3.35rem] font-semibold leading-[0.98] tracking-[-0.045em] text-text-primary"
        >
          Every conversation becomes a <span className="text-primary-300">decision record</span>
        </motion.h1>
      </motion.header>

      <div className="slide-content relative z-10 grid grid-rows-[1fr_auto] gap-4">
        <div className="grid min-h-0 grid-cols-[1.18fr_0.74fr_1.08fr] gap-4">
          <motion.section
            className="glass relative flex min-w-0 flex-col overflow-hidden rounded-2xl p-4"
          ...
          >
            ...
            <div className="relative mt-3 grid flex-1 grid-cols-2 content-center gap-2.5">
          ...
          >
            ...
            <div className="relative mt-3 flex items-center gap-2">
              <div className="flex min-w-0 flex-1 items-center gap-2 rounded-lg border border-border-default/70 bg-bg-base/50 px-3 py-2">
                ...
                <span className="truncate font-body text-xs text-text-muted">Search lead details…</span>
              </div>
        ...
        <motion.section
          className="flex items-center justify-between gap-5 rounded-2xl border border-primary-300/30 bg-primary-500/15 px-5 py-3 backdrop-blur-xl"
