...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["source_template_version_id"], ["category_template_versions.id"], name="fk_tenant_kb_versions_source_template_version_id_category_template_versions", ondelete="SET NULL"),
    ...
    with op.batch_alter_table("tenant_knowledge_bases") as batch:
        batch.create_foreign_key(
            "fk_tenant_knowledge_bases_active_version_id_tenant_knowledge_base_versions",
            "tenant_knowledge_base_versions",
            ["active_version_id"],
            ["id"],
        )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["tenant_knowledge_base_version_id"], ["tenant_knowledge_base_versions.id"], name="fk_tenant_kb_questions_tenant_knowledge_base_version_id_tenant_knowledge_base_versions", ondelete="CASCADE"),
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("tenant_knowledge_bases") as batch:
        batch.drop_constraint("fk_tenant_knowledge_bases_active_version_id_tenant_knowledge_base_versions", type_="foreignkey")
